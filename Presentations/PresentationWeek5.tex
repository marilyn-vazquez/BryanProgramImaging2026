...
\begin{frame}{Gravity Experiment}
    ...
    \end{itemize}
        \centering
        \includegraphics[height=0.6\textheight]{Stub4C (1).jpg}
...
\centering
\includegraphics[width=\textwidth]{HumanVsComputer.png}
\end{frame}
...
\begin{frame}{Diagram}
    \centering
    \includegraphics[width=1.\textwidth]{Pipeline Diagramv2.drawio (1).png}
\end{frame}
...
\includegraphics[width=0.5\textwidth]{Image Preprocessing.png}
\end{column} 
\begin{column}{0.48\textwidth} 
\includegraphics[width=0.75\textwidth]{processed.png} 
\end{column} 
\end{columns} 
\end{frame}
...
\end{itemize}
    ...
    \begin{column}{0.48\textwidth}
        ...
        \includegraphics[
            width=\linewidth,
            height=0.65\textheight]{PHandFiltrations.png}
    \end{column}
...
\begin{frame}{Lower/Upper Star}
    ...
    \begin{figure}
   \centering
\includegraphics[width=\textwidth]{upper.png}
\end{figure}
\end{frame}
...
%    \begin{figure}
%    \centering
%\includegraphics[width=\textwidth]{lowerandupper.png}
%\end{figure}
%\end{frame}

\begin{frame}{Morphology}
    \centering
\includegraphics[width=\textwidth]{closing.png}
\end{frame}

\begin{frame}{Density}
 \centering
\includegraphics[width=.65\textwidth]{Figure 2026-06-24 150818.png}
\end{frame}  
...
\centering
\includegraphics[width=.65\textwidth]{Vectorization Diagram.png}
...
\centering
\includegraphics[width=\textwidth]{barcode.png}
...
\begin{column}{0.48\textwidth}
\includegraphics[width=\textwidth]{Persistent Binning example.png}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Vectorization: Imaging}
    ...
    \includegraphics[width=0.65\textwidth]{logimaging.png}

    \vspace{0.4cm}

    \includegraphics[width=0.35\textwidth]{lowerstar.png}
\end{frame}
...
\end{itemize}
    ...
    \begin{column}{0.48\textwidth}
        ...
        \includegraphics[
            width=0.5\linewidth,
            height=.75\textheight]{neuralnetwork}
    \end{column}
...
\centering
\includegraphics[width=\textwidth]{barcodeclass.png}
\end{frame}

\begin{frame}{Binning Classification}
\centering
\includegraphics[width = 0.9\textwidth]{svmBinning.png}
\end{frame}

\begin{frame}{Imaging Classification}
    \centering
    \includegraphics[width=0.9\textwidth]{svmimaging.png}
\end{frame}
