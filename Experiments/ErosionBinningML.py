# -*- coding: utf-8 -*-
"""
Erosion Filtration Persistence Binning Validation Experiment

Pipeline:
    1. Load V2 preprocessed microscopy images
    2. Convert each image to binary using a fixed threshold
    3. Apply erosion with increasing square structuring elements
...
def erosion(
    ...
    For each foreground pixel, the output value is the minimum value found
    within the structuring-element neighborhood. This shrinks foreground
    regions and can remove thin structures.
    ...
    minimal_pixel_value : int or float, optional
        Pixel value representing the background. Default is 0.

    Returns
    -------
    numpy.ndarray
        Eroded binary image with the same shape as ``input_np_array``.
    """
...
if __name__ == "__main__":
    ...
    print("\n============================================")
    print("BUILDING EROSION V2 PERSISTENCE-BINNING DATASET")
    print("============================================")
