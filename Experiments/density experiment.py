...
4. Computes raw density persistent homology via Cripser and saves .npy arrays for each image.
...
7. Exports classifier performance metrics to a CSV file.
"""
...
def run_ml_benchmark(X_tda, y, output_dir, dataset_title="Density Barcode Experiment"):
    ...
    # -----------------------------------------------------------------
    # 🔬 PDB CHECKPOINT: INSPECT CLASSIFIERS & PERFORMANCE METRICS
    # -----------------------------------------------------------------
    # Uncomment the line below to drop into a debugger shell here
    # pdb.set_trace()
    # -----------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    for path in processed_paths:
        ...
        # -------------------------------------------------------------
        # Uncomment the line below to inspect variables per image (e.g., density_img, ph_diagram)
        # pdb.set_trace()
        # -------------------------------------------------------------

        # 4. Save the raw persistence diagram matrix [dim, birth, death] for each image
    ...
    # -----------------------------------------------------------------
    # Uncomment the line below to inspect global feature arrays before modeling
    # pdb.set_trace()
    # -----------------------------------------------------------------
