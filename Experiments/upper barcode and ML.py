# -*- coding: utf-8 -*-
"""
Created on Tue Jul 14 10:01:37 2026
...
# =====================================================================
# 1. BARCODE VECTORIZATION (FROM RAW UPPER-STAR DIAGRAMS)
# =====================================================================
...
if __name__ == '__main__':
    ...
    # Folder containing your upper-star .npy diagram checkpoints
    PROCESSED_DIR = Path(r"C:\Users\chloe\OneDrive - Simpson College\IMAGES2.0\All Images\preprocessed_images")
   
    # Gather saved raw upper-star diagram arrays
    diagram_paths = sorted(list(PROCESSED_DIR.glob('*_upper_star_diagram.npy')))
   
    if not diagram_paths:
        raise FileNotFoundError(
            f"Could not find any upper star diagrams (*_upper_star_diagram.npy) in {PROCESSED_DIR}.\n"
            f"Please ensure you generate these diagrams from your upper-star extraction step."
        )
    ...
    X_topological_features, y_experimental_classes = vectorize_upper_star_diagrams(diagram_paths)
    ...
    print("\n=== Running Support Vector Machines & Neural Network (Upper-Star) ===")
    ...
    if len(X_topological_features) < 5:
        ...
        run_ml_benchmark(
            ...
            dataset_title="Upper-Star Barcode Machine Learning Experiment"
        )