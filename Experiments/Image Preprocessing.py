...
if __name__ == '__main__':
    # Define paths
    IMAGE_DIR = Path(r"C:\Users\g_gar\OneDrive - Simpson College\Chloe Jamieson's files - IMAGES2.0\All Images")
    ...
    reference_image = (IMAGE_DIR / "control_stub1_3-2-26_0046.tif")
