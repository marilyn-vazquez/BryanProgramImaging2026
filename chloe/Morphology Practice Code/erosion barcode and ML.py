...
def run_ml_benchmark(X_tda, y, output_dir):
    ...
    ax.set_title("Erosion PCA Data", fontsize=9, weight="bold")
...
if __name__ == '__main__':
    ...
    print("=== Phase 1: Running Erosion TDA Filtrations Directly on Images ===")
    ...
    for path in raw_paths:
        ...
        pds = persistence_of_morph_filtration(binary_img, kernels, morph_type='erosion')
    ...
    np.save(RAW_IMG_DIR / "step2_erosion_10d_features.npy", X_features)
    np.save(RAW_IMG_DIR / "step2_erosion_labels.npy", y_labels)
    print("✅ Vectorized 10D erosion arrays cached to disk.\n")

    print("=== Phase 2: Running Machine Learning Benchmark (Erosion) ===")
