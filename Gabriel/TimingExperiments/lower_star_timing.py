# -*- coding: utf-8 -*-
"""
Lower-Star Persistence Binning Timing Experiment

Pipeline:
    1. Load V2 preprocessed microscopy images
    2. Build the lower-star filtration for every image
...
# =====================================================================
# 2. LOWER-STAR FILTRATION
# =====================================================================

def build_lower_star_filtration(loaded_image):
    """
    Prepare the lower-star filtration image.

    Lower Star uses image intensity values directly. This stage converts
    the loaded image to floating point, scales it to 0-255 when necessary,
    and creates the float64 filtration array.
    """
    filtration_image = img_as_float(loaded_image)

    if filtration_image.max() <= 1.0:
        filtration_image = filtration_image * 255.0
...
# =====================================================================
# 3. LOWER-STAR PERSISTENT HOMOLOGY
# =====================================================================

def compute_lower_star(filtration_image):
...
def build_and_time_lower_star_dataset(
    image_paths,
    ph_output_dir,
    ...
    for image_number, image_path in enumerate(image_paths, start=1):
        ...
        # ---------------------------------------------------------
        # TIME LOWER-STAR FILTRATION CONSTRUCTION
        # ---------------------------------------------------------

        filtration_start = perf_counter()

        filtration_image = build_lower_star_filtration(loaded_image)
        ...
        ph_lower = compute_lower_star(filtration_image)

        ph_time = perf_counter() - ph_start

        # Saving occurs after the PH timer stops.
        ph_filename = f"{image_path.stem}_lower_star_ph.npy"
...
if __name__ == "__main__":
    ...
    print("\n============================================")
    print("LOWER-STAR TIMING EXPERIMENT")
    print("============================================")
    ...
    (
        ...
        manifest_df,
        image_timings_df,
    ) = build_and_time_lower_star_dataset(
